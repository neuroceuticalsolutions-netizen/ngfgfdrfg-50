  ...
  return <section className="py-20 bg-subtle-gradient">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-medium hover-lift">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8 animate-fade-in-up" style={{
            animationDelay: '0.6s'
          }}>
              <div className="text-center">
                ...
                <p className="text-sm text-grey-600 mt-1">South African Based</p>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-fresh-teal">🧬</div>
                <p className="text-sm text-grey-600 mt-1">Science Backed</p>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-fresh-teal">🤝</div>
                <p className="text-sm text-grey-600 mt-1">Trusted Partners</p>
              </div>
            </div>
          </div>
        </div>
