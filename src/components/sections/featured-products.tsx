      ...
      <div className="container mx-auto px-6">
        ...
        <div className="relative mb-12">
          <Carousel className="w-full max-w-7xl mx-auto group" setApi={setApi}>
            ...
            {/*
              Desktop arrows: keep vertical centering, but place both over the right-side logo area
              so they feel grouped and visually balanced.
            */}
            <CarouselPrevious className="hidden sm:flex left-auto right-24 lg:right-28 top-1/2 -translate-y-1/2 z-20 w-12 h-12 lg:w-14 lg:h-14 bg-royal-purple/20 hover:bg-royal-purple/40 border-0 text-royal-purple hover:text-white backdrop-blur-sm shadow-lg transition-all duration-300" />
