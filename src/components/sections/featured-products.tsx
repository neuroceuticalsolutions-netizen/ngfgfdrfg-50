      ...
      <div className="container mx-auto px-6">
        ...
        <div className="relative mb-12">
          <Carousel className="w-full max-w-6xl mx-auto group" setApi={setApi}>
            ...
            <CarouselNext className="hidden sm:flex left-auto right-[calc(55%-360px)] top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-white border-border shadow-medium opacity-70 hover:opacity-100 transition-opacity duration-300" />
