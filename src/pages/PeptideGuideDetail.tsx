...
import { getPeptideArticleBySlug } from "@/data/peptides";
import NotFound from "./NotFound";

const BASE_URL = "https://neuroceutical.lovable.app";

const PeptideGuideDetail = () => {
  const { slug } = useParams<{ slug: string }>();
  const article = slug ? getPeptideArticleBySlug(slug) : undefined;
  ...
  return (
    <main className="min-h-screen bg-background">
      <SEOHead
        ...
        path={`/peptides/guides/${article.slug}`}
      />
      <BreadcrumbSchema
        items={[
          ...
          { name: article.title, url: `${BASE_URL}/peptides/guides/${article.slug}` },
        ]}
      />
      <Navigation />
...
export default PeptideGuideDetail;